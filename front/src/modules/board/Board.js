                    ...
                    <List className="projects">
                        {(activeIndex === 1 || activeIndex === 0) &&
                            ...
                            listAds
                                ...
                                .map((i) => (
                                    <Ads key={i.id_ads} ads={i} onDelete={onDeleteBoard} onEditAds={onEditAds} viewMode={viewMode} />
                                ))}
                        {(activeIndex === 2 || activeIndex === 0) &&
                            ...
                            listArchiveAds
                                ...
                                .map((i) => (
                                    <Ads key={i.id_ads} ads={i} onDelete={onDeleteToArchiveAds} onEditAds={onEditAds} viewMode={viewMode} />
                                ))}
                    </List>
                    {user.role === 'ADMIN' && (
