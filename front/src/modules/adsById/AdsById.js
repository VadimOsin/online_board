...
import {getAllComments, addComment, createComments} from './axios/comments';
    ...
    const handleCommentSubmit = async () => {
        if (newComment.trim() !== '') {
            ...
            const newCommentData = {
                ...
                date_created: currentDate.toLocaleDateString('en-US', {
                    year: 'numeric',
                    month: 'long',
                    day: 'numeric',
                }),
            ...
            try {
                await createComments("", newCommentData.text, currentDate, user.id, id).catch(e => console.log(e.data.message));
                                            ...
                                            {comments.map((comment, index) => (
                                                <React.Fragment key={index}>
                                                    <Paper elevation={3} style={{
                                                        ...
                                                        <ListItem>
                                                            <ListItemText primary={`${comment?.user?.login}`}
